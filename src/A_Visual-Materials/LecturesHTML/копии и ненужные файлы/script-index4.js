...
function linkIndexClick() {
  ...
  let up_href = "";
	...
	if (inn_link) {		
		...
		//demo.insertAdjacentHTML("beforeend", "<br>back_href: " + back_href);//!!!!!!!!!!!!!!!!!Demo
		if (back_href.indexOf("#") != -1) {	
			...
			//demo.insertAdjacentHTML("beforeend", "<br>search up_href: " + up_href);//!!!!!!!!!!!!!!!!!Demo
			anchor = frame.contentWindow.document.querySelector(".inner-anchor[href='" + up_href + "']");			
			
			//demo.insertAdjacentHTML("beforeend", "<br>page down_href: " + down_href);//!!!!!!!!!!!!!!!!!Demo				
