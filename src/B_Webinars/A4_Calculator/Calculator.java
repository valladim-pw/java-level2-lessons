package B_Webinars.A4_Calculator;
...
public class Calculator {
	...
	public static int calculate(String expression) {
		...
		while(operands.size() > 1) {
			...
			System.out.println("operands2: " + operands);
			i++;
		}
		System.out.println(Integer.valueOf(operands.getFirst()));
	...
	public static void main(String[] args) {
		...
		int r = 6 + i;
		String test ="(2-8)/(2*(4+1))";
		String sub = "";
		sub = test.substring(test.lastIndexOf("("), test.indexOf(")", test.lastIndexOf("(")) + 1);
		test = test.replace(sub, Integer.toString(5));
...
//		String sub2 = "";
//		sub2 = test.substring(test.lastIndexOf("("), test.indexOf(")", test.lastIndexOf("(")) + 1);
//		test = test.replace(sub2, Integer.toString(6));
